...
def get_neighbors(pos, grid_map, rows, cols):
    ...
    Input: currnet cell, map
    Output: neighboring cell, distance to them
    '''
    # directions of four neighboring cells - NSWE
    ...
    for d in dirs:
        ...
        # if the cell is in range and free, set distance to 1
